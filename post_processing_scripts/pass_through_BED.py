...
###################################################################################################
#
#   Pass through layers directly from CMEMS (sea bed temperature)
#   
#   input  in CMEMS netcdf format   
#   output in COARDS netcdf format
#
#   usage: pass_through_BED.py  <BED-data>  <BED-data-out>  
#
#   
###################################################################################################
...
info = {'variable_name':"seabed_temperature",
                 'units':'deg',
                 'time' : data.ncfdata.ncf.variables["time"][:],
                 'long_name':'Sea bed potential temperature'}
#
